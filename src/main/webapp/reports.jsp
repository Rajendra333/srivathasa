...
<center>Customer Id<input type="text" name="customer_id" onblur="notnul(this.id,this.value)" >
Product ID<input type="text" name="test_id" onblur="notnul(this.id,this.value)" >
